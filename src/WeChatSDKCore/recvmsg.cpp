...
int __stdcall fakeRecvTextMsg(PRecvMsgPack msg)
{
	...
	MessageBox(NULL, msg->msg->wxid1.buf, L"发消息的wxid", MB_OK);
    MessageBox(NULL, CoreGetCurrentWxid(), L"当前wxid", MB_OK);

	if (msg->msg->wxid1.buf == CoreGetCurrentWxid()) {
