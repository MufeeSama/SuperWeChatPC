...
handle_t WechatRsClk_IfHandle;


static const RPC_CLIENT_INTERFACE WechatSDKClk___RpcClientInterface =
    {
...
RPC_IF_HANDLE WechatSDKClk_v1_0_c_ifspec = (RPC_IF_HANDLE)& WechatSDKClk___RpcClientInterface;

extern const MIDL_STUB_DESC WechatSDKClk_StubDesc;

static RPC_BINDING_HANDLE WechatSDKClk__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ wchar_t *msg)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&WechatSDKClk_StubDesc,
                  (PFORMAT_STRING) &sdkclk__MIDL_ProcFormatString.Format[0],
    ...
    /* [string][in] */ wchar_t *msg)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&WechatSDKClk_StubDesc,
                  (PFORMAT_STRING) &sdkclk__MIDL_ProcFormatString.Format[54],
                  ( unsigned char * )&funptr);
    return ( int  )_RetVal.Simple;
    ...
    /* [string][in] */ wchar_t *msg)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&WechatSDKClk_StubDesc,
                  (PFORMAT_STRING) &sdkclk__MIDL_ProcFormatString.Format[114],
                  ( unsigned char * )&funptr);
    return ( int  )_RetVal.Simple;
